// My code: this array contains the coordinates for all BART stops between SF and San Jose
...
function move() {
  ...
  setTimeout( () => {
    if (index >= bartStops.length) { 
      ...
      marker.setLngLat(bartStops[index]); // set marker length/latitude to the array’s index
      index++; 
      move(); 
    }
  }, 1000);  
